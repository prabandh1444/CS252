 ...
 *      ./waf --run "hidden-stns" (or ./ns3 run "hidden-stns")
 *
 *    To run from cli, with RTS/CTS enabled and contention enabled:
 *     ./waf --run "hidden-stns --enable_rts --contention" (or ./ns3 run "hidden-stns --enable_rts --contention")
 *
 *    To get more info about the command line options:
 *      ./waf --run "hidden-stns --help" (or ./ns3 run "hidden-stns --help")
 **/
